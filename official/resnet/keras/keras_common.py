...
def get_callbacks(learning_rate_schedule_fn, num_images, starting_batch=0, starting_epoch=0, agent=None):
  """Returns common callbacks."""
  time_callback = keras_utils.TimeHistory(
    FLAGS.batch_size, FLAGS.log_steps, starting_batch, agent)
