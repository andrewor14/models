...
def set_cuda_visible_devices(num_gpus_per_worker):
  ...
  This assumes CUDA_VISIBLE_DEVICES and TF_CONFIG are already set and `num_gpus_per_worker`
  divides the number of devices in CUDA_VISIBLE_DEVICES. This should be called every time
  after TF_CONFIG changes.
  """
